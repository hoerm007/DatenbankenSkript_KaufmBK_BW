...
\begin{document}
	...
	\input{./Arbeitsblaetter/ERM.tex}
	\newpage
	\input{./Arbeitsblaetter/DarstellungDB.tex}
	\newpage
	\input{./Arbeitsblaetter/Anomalien.tex}
	\newpage
	\input{./Arbeitsblaetter/Normalisieren.tex}
	\newpage
	\input{./Arbeitsblaetter/Optimieren.tex}
	\newpage
	\input{./Arbeitsblaetter/Datentypen.tex}
	\newpage
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\rohead{DBMS und SQL}
	\input{./Arbeitsblaetter/DBMS.tex}
	\newpage
	\input{./Arbeitsblaetter/Befuellen.tex}
	\newpage
	\input{./Arbeitsblaetter/Select.tex}
	\newpage
	\input{./Arbeitsblaetter/Where.tex}
	\newpage
	\input{./Arbeitsblaetter/Delete.tex}
	\input{./Arbeitsblaetter/Update.tex}
	\newpage
	\input{./Arbeitsblaetter/Funktionen.tex}
	\newpage
	\input{./Arbeitsblaetter/Join.tex}
    \newpage
    ...
    \input{./Arbeitsblaetter/Anhang.tex}
\end{document}
